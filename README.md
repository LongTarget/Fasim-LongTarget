...
```
./fasim -f testDNA.fa -s H19.fa -O /home/test/example -c 6000 -i 70 -S 1.0 -nt 25 -na 1000 -pc 1 -pt -500 -ds 10 -lg 60 
```
...
F	doFastSim			if true, SIM function will be used instead of fastSIM function.
```
